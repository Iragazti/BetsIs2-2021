...
public class AdminGUI extends JFrame {
	...
	public void AdminGUIExekuzioa() throws Exception{
		...
		String a = "Etiquetas";
		this.setTitle(ResourceBundle.getBundle(a).getString("Admin")); //$NON-NLS-1$ //$NON-NLS-2$
		...
		JLabel lblNewLabel = new JLabel(ResourceBundle.getBundle(a).getString("Welcome")+" "+admin.getErabiltzaileIzena()+"!"); //$NON-NLS-1$ //$NON-NLS-2$
		lblNewLabel.setBounds(124, 23, 250, 29);
		contentPane.add(lblNewLabel);
		
		JButton btnNewButton = new JButton(ResourceBundle.getBundle(a).getString("SignOut"));
		...
		btnCreateQuestion.setText(ResourceBundle.getBundle(a).getString("CreateQuestion")); //$NON-NLS-1$ //$NON-NLS-2$
		...
		eguneratuHilabetekoak.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				done.setText(ResourceBundle.getBundle(a).getString("Done"));
			}
		});
		eguneratuHilabetekoak.setText(ResourceBundle.getBundle(a).getString("ResetMonth")); //$NON-NLS-1$ //$NON-NLS-2$
		...
		puntuazioakIkusi.setText(ResourceBundle.getBundle(a).getString("ViewWorker")); //$NON-NLS-1$ //$NON-NLS-2$
